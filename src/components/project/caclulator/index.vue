    ...
    <div id="app1">
        ...
        <div>
            <div class="grid-container">
                <div class="circle grid-item" v-for="item in listAct" :class="{'active': item.isActive}" @click="action(item)">
                    <div class="inner">{{ item.label }}</div>
                </div>
                <div class="grid-container container-3">
                    <div class="circle grid-item number" v-for="item in 9" @click="actionNum(item)">
